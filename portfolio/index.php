...
<head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="front_end_assets/img/favicons.png">
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.php" class="navbar-brand logo-sticky-none"><img src="front_end_assets/img/logo/logos.png" alt="Logo"></a>
                                    <a href="index.php" class="navbar-brand s-logo-none"><img src="front_end_assets/img/logo/glogos.png" alt="Logo"></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s">Halo..!</h6>
                                <h2 style="font-size: 3em;" class="wow fadeInUp" data-wow-delay="0.4s">Saya <?=$about_me['name']?> </h2>
